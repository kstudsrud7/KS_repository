...
// Type: ArcticIT.Core.Entities.AutoNumberPlugin
...
{
  [CRMMetadata(EntityName = "ait_autonumber", CrmEntityType = "ArcticIT.EarlyBound.Entities.ait_autonumber")]
  public class AutoNumberPlugin : EntityBase
  {
    public AutoNumberPlugin(
    ...
    {
      return (Entity) this.GetInputEntity<ait_autonumber>(this.ActionType, Global.Stage.PRE);
    }

    protected override Entity GetPreImageForUpdate()
    {
      return (Entity) this.GetEntityFromPreImage<ait_autonumber>();
    }

    protected override string GenerateFormattedName(Entity entityInput, Entity preImage)
    {
      string empty = string.Empty;
      ait_autonumber aitAutonumber1 = (ait_autonumber) entityInput;
      ait_autonumber aitAutonumber2 = (ait_autonumber) preImage;
      return FormatLibrary.FormatName(FormatLibrary.GetEntityValue(aitAutonumber1.ait_entitylogicalname, aitAutonumber2.ait_entitylogicalname), FormatLibrary.GetEntityValue(aitAutonumber1.ait_attributename, aitAutonumber2.ait_attributename));
    }
  }
}
