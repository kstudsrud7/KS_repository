...
// Type: ArcticIT.Core.Entities.CommitteeMember
...
{
  [CRMMetadata(EntityName = "ait_committeemember", CrmEntityType = "ArcticIT.CrmFramework.Plugins.EarlyBound.ait_committeemember")]
  public class CommitteeMember : EntityBase
  {
    ...
    {
      return (Entity) this.GetInputEntity<ait_committeemember>(this.ActionType, Global.Stage.PRE);
    }

    protected override Entity GetPreImageForUpdate()
    {
      return (Entity) this.GetEntityFromPreImage<ait_committeemember>();
    }

    protected override string GenerateFormattedName(Entity entityInput, Entity preImage)
    {
      string empty = string.Empty;
      ait_committeemember aitCommitteemember1 = (ait_committeemember) entityInput;
      ait_committeemember aitCommitteemember2 = (ait_committeemember) preImage;
      return FormatLibrary.FormatName(FormatLibrary.GetEntityValue((IOrganizationService) this.CrmService, aitCommitteemember1.ait_committee, aitCommitteemember2.ait_committee), FormatLibrary.GetEntityValue((IOrganizationService) this.CrmService, aitCommitteemember1.ait_contact, aitCommitteemember2.ait_contact));
    }
  }
}
