...
// Type: ArcticIT.EarlyBound.Entities.TranslationProcess
...
namespace ArcticIT.EarlyBound.Entities
{
  ...
  public class TranslationProcess : Entity, INotifyPropertyChanging, INotifyPropertyChanged
  {
    ...
    public TranslationProcessState? statecode
    {
      get
      {
        OptionSetValue attributeValue = this.GetAttributeValue<OptionSetValue>(nameof (statecode));
        return attributeValue != null ? new TranslationProcessState?((TranslationProcessState) Enum.ToObject(typeof (TranslationProcessState), attributeValue.Value)) : new TranslationProcessState?();
      }
      set
      {
    ...
    public IEnumerable<WorkflowLog> lk_translationprocess_workflowlogs
    {
      get
      {
        return this.GetRelatedEntities<WorkflowLog>(nameof (lk_translationprocess_workflowlogs), new EntityRole?());
      }
      set
      {
        this.OnPropertyChanging(nameof (lk_translationprocess_workflowlogs));
        this.SetRelatedEntities<WorkflowLog>(nameof (lk_translationprocess_workflowlogs), new EntityRole?(), value);
    ...
    public IEnumerable<ProcessSession> TranslationProcess_ProcessSessions
    {
      get
      {
        return this.GetRelatedEntities<ProcessSession>(nameof (TranslationProcess_ProcessSessions), new EntityRole?());
      }
      set
      {
        this.OnPropertyChanging(nameof (TranslationProcess_ProcessSessions));
        this.SetRelatedEntities<ProcessSession>(nameof (TranslationProcess_ProcessSessions), new EntityRole?(), value);
        this.OnPropertyChanged(nameof (TranslationProcess_ProcessSessions));
      }
    }

    [RelationshipSchemaName("TranslationProcess_SyncErrors")]
    public IEnumerable<SyncError> TranslationProcess_SyncErrors
    {
      get
      {
        return this.GetRelatedEntities<SyncError>(nameof (TranslationProcess_SyncErrors), new EntityRole?());
      }
      set
      {
        this.OnPropertyChanging(nameof (TranslationProcess_SyncErrors));
        this.SetRelatedEntities<SyncError>(nameof (TranslationProcess_SyncErrors), new EntityRole?(), value);
    ...
    public ProcessStage lk_translationprocess_activestageid
    {
      get
      {
        return this.GetRelatedEntity<ProcessStage>(nameof (lk_translationprocess_activestageid), new EntityRole?());
      }
      set
      {
        this.OnPropertyChanging(nameof (lk_translationprocess_activestageid));
        this.SetRelatedEntity<ProcessStage>(nameof (lk_translationprocess_activestageid), new EntityRole?(), value);
    ...
    public SystemUser lk_translationprocess_createdby
    {
      get
      {
        return this.GetRelatedEntity<SystemUser>(nameof (lk_translationprocess_createdby), new EntityRole?());
      }
    }
    ...
    public SystemUser lk_translationprocess_createdonbehalfby
    {
      get
      {
        return this.GetRelatedEntity<SystemUser>(nameof (lk_translationprocess_createdonbehalfby), new EntityRole?());
      }
      set
      {
        this.OnPropertyChanging(nameof (lk_translationprocess_createdonbehalfby));
        this.SetRelatedEntity<SystemUser>(nameof (lk_translationprocess_createdonbehalfby), new EntityRole?(), value);
        this.OnPropertyChanged(nameof (lk_translationprocess_createdonbehalfby));
      }
    }
    ...
    public KnowledgeArticle lk_translationprocess_knowledgearticleid
    {
      get
      {
        return this.GetRelatedEntity<KnowledgeArticle>(nameof (lk_translationprocess_knowledgearticleid), new EntityRole?());
      }
      set
      {
        this.OnPropertyChanging(nameof (lk_translationprocess_knowledgearticleid));
        this.SetRelatedEntity<KnowledgeArticle>(nameof (lk_translationprocess_knowledgearticleid), new EntityRole?(), value);
    ...
    public SystemUser lk_translationprocess_modifiedby
    {
      get
      {
        return this.GetRelatedEntity<SystemUser>(nameof (lk_translationprocess_modifiedby), new EntityRole?());
      }
    }
    ...
    public SystemUser lk_translationprocess_modifiedonbehalfby
    {
      get
      {
        return this.GetRelatedEntity<SystemUser>(nameof (lk_translationprocess_modifiedonbehalfby), new EntityRole?());
      }
      set
      {
        this.OnPropertyChanging(nameof (lk_translationprocess_modifiedonbehalfby));
        this.SetRelatedEntity<SystemUser>(nameof (lk_translationprocess_modifiedonbehalfby), new EntityRole?(), value);
        this.OnPropertyChanged(nameof (lk_translationprocess_modifiedonbehalfby));
      }
    }
    ...
    public Workflow lk_translationprocess_processid
    {
      get
      {
        return this.GetRelatedEntity<Workflow>(nameof (lk_translationprocess_processid), new EntityRole?());
      }
      set
      {
        this.OnPropertyChanging(nameof (lk_translationprocess_processid));
        this.SetRelatedEntity<Workflow>(nameof (lk_translationprocess_processid), new EntityRole?(), value);
    ...
    public Organization organization_translationprocess
    {
      get
      {
        return this.GetRelatedEntity<Organization>(nameof (organization_translationprocess), new EntityRole?());
      }
    }
    ...
    public TransactionCurrency transactioncurrency_translationprocess
    {
      get
      {
        return this.GetRelatedEntity<TransactionCurrency>(nameof (transactioncurrency_translationprocess), new EntityRole?());
      }
      set
      {
        this.OnPropertyChanging(nameof (transactioncurrency_translationprocess));
        this.SetRelatedEntity<TransactionCurrency>(nameof (transactioncurrency_translationprocess), new EntityRole?(), value);
