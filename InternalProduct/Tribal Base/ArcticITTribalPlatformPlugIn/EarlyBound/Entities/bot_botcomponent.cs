...
// Type: ArcticIT.EarlyBound.Entities.bot_botcomponent
...
{
  [DataContract]
  [Microsoft.Xrm.Sdk.Client.EntityLogicalName("bot_botcomponent")]
  [GeneratedCode("CrmSvcUtil", "9.1.0.45")]
  public class bot_botcomponent : Entity, INotifyPropertyChanging, INotifyPropertyChanged
  {
    ...
    [AttributeLogicalName("bot_botcomponentid")]
    public Guid? bot_botcomponentId => this.GetAttributeValue<Guid?>("bot_botcomponentid");
    ...
    public Guid? botid => this.GetAttributeValue<Guid?>(nameof (botid));
      ...
      : this()
    {
      foreach (PropertyInfo property in anonymousType.GetType().GetProperties())
      {
        ...
        switch (str)
        {
          case "id":
            base.Id = (Guid) obj;
            ((DataCollection<string, object>) this.Attributes)["bot_botcomponentid"] = (object) base.Id;
            break;
