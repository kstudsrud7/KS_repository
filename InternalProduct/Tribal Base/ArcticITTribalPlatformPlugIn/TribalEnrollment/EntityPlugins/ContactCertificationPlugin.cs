...
// Type: ArcticIT.TribalEnrollment.EntityPlugins.ContactCertificationPlugin
...
{
  [CRMMetadata(EntityName = "ait_contactcertification", CrmEntityType = "ArcticIT.EarlyBound.Entities.ait_contactcertification")]
  public class ContactCertificationPlugin : EntityBase
  {
    public ContactCertificationPlugin(
    ...
    {
      return (Entity) this.GetInputEntity<ait_contactcertification>(this.ActionType, Global.Stage.PRE);
    }

    protected override Entity GetPreImageForUpdate()
    {
      return (Entity) this.GetEntityFromPreImage<ait_contactcertification>();
    }

    protected override string GenerateFormattedName(Entity entityInput, Entity preImage)
    {
      string empty = string.Empty;
      ait_contactcertification contactcertification1 = (ait_contactcertification) entityInput;
      ait_contactcertification contactcertification2 = (ait_contactcertification) preImage;
      return FormatLibrary.FormatName(FormatLibrary.GetEntityValue((IOrganizationService) this.CrmService, contactcertification1.ait_contact, contactcertification2.ait_contact), FormatLibrary.GetEntityValue((IOrganizationService) this.CrmService, contactcertification1.ait_certification, contactcertification2.ait_certification));
    }
  }
}
