...
// Type: ArcticIT.TribalEnrollment.EntityPlugins.ContactLanguagePlugin
...
{
  [CRMMetadata(EntityName = "ait_contactlanguage", CrmEntityType = "ArcticIT.EarlyBound.Entities.ait_contactlanguage")]
  public class ContactLanguagePlugin : EntityBase
  {
    public ContactLanguagePlugin(
    ...
    {
      return (Entity) this.GetInputEntity<ait_contactlanguage>(this.ActionType, Global.Stage.PRE);
    }

    protected override Entity GetPreImageForUpdate()
    {
      return (Entity) this.GetEntityFromPreImage<ait_contactlanguage>();
    }

    protected override string GenerateFormattedName(Entity entityInput, Entity preImage)
    {
      string empty = string.Empty;
      ait_contactlanguage aitContactlanguage1 = (ait_contactlanguage) entityInput;
      ait_contactlanguage aitContactlanguage2 = (ait_contactlanguage) preImage;
      return FormatLibrary.FormatName(FormatLibrary.GetEntityValue((IOrganizationService) this.CrmService, aitContactlanguage1.ait_contact, aitContactlanguage2.ait_contact), FormatLibrary.GetEntityValue((IOrganizationService) this.CrmService, aitContactlanguage1.ait_Language, aitContactlanguage2.ait_Language), FormatLibrary.GetEntityValue((IOrganizationService) this.CrmService, aitContactlanguage1.ait_proficiency, aitContactlanguage2.ait_proficiency));
    }

    private void Validate()
    {
      if (this.GetInputEntity<ait_contactlanguage>().ait_contact == null)
