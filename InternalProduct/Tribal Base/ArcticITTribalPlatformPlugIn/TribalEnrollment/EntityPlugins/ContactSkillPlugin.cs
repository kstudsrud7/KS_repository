...
// Type: ArcticIT.TribalEnrollment.EntityPlugins.ContactSkillPlugin
...
{
  [CRMMetadata(EntityName = "ait_contactskill", CrmEntityType = "ArcticIT.EarlyBound.Entities.ait_contactskill")]
  public class ContactSkillPlugin : EntityBase
  {
    public ContactSkillPlugin(
    ...
    {
      return (Entity) this.GetInputEntity<ait_contactskill>(this.ActionType, Global.Stage.PRE);
    }

    protected override Entity GetPreImageForUpdate()
    {
      return (Entity) this.GetEntityFromPreImage<ait_contactskill>();
    }

    protected override string GenerateFormattedName(Entity entityInput, Entity preImage)
    {
      string empty = string.Empty;
      ait_contactskill aitContactskill1 = (ait_contactskill) entityInput;
      ait_contactskill aitContactskill2 = (ait_contactskill) preImage;
      return FormatLibrary.FormatName(FormatLibrary.GetEntityValue((IOrganizationService) this.CrmService, aitContactskill1.ait_contact, aitContactskill2.ait_contact), FormatLibrary.GetEntityValue((IOrganizationService) this.CrmService, aitContactskill1.ait_skill, aitContactskill2.ait_skill));
    }

    private void Validate()
    {
      if (this.GetInputEntity<ait_contactskill>().ait_contact == null)
