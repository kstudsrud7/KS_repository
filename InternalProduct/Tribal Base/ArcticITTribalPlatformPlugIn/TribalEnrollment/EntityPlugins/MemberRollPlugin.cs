...
// Type: ArcticIT.TribalEnrollment.EntityPlugins.MemberRollPlugin
...
{
  [CRMMetadata(EntityName = "ait_memberroll", CrmEntityType = "ArcticIT.EarlyBound.Entities.ait_memberroll")]
  public class MemberRollPlugin : EntityBase
  {
    public MemberRollPlugin(
    ...
    {
      return (Entity) this.GetInputEntity<ait_memberroll>(this.ActionType, Global.Stage.PRE);
    }

    protected override Entity GetPreImageForUpdate()
    {
      return (Entity) this.GetEntityFromPreImage<ait_memberroll>();
    }

    protected override string GenerateFormattedName(Entity entityInput, Entity preImage)
    {
      string empty = string.Empty;
      ait_memberroll aitMemberroll1 = (ait_memberroll) entityInput;
      ait_memberroll aitMemberroll2 = (ait_memberroll) preImage;
      return FormatLibrary.FormatName(FormatLibrary.GetEntityValue((IOrganizationService) this.CrmService, aitMemberroll1.ait_memberprofile, aitMemberroll2.ait_memberprofile), FormatLibrary.GetEntityValue((IOrganizationService) this.CrmService, aitMemberroll1.ait_roll, aitMemberroll2.ait_roll));
    }
  }
}
