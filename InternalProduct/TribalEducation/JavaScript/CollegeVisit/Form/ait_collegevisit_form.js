    ...
    if (emergencyContactName) {
        ...
        Xrm.WebApi.retrieveRecord(entityName, entityId, expandQuery).then(
            function success(result) {
                console.log("Retrieve Record: ", result);
                if (result && result.ait_Contact) {
                    ...
                    if (primaryPhone) {
                        ...
                        Xrm.Page.getAttribute("ait_emergencycontactphonenumber").setValue(null);
                    }
                } else {
        ...
        // Clear the emergency contact phone number field if emergency contact name is not selected
        Xrm.Page.getAttribute("ait_emergencycontactphonenumber").setValue(null);
    }
}
