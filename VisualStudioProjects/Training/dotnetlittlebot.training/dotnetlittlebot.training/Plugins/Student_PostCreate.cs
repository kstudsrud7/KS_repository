	...
	public class Student_PostCreate : IPlugin
	{
		public void Execute(IServiceProvider serviceProvider)
		{
			...
			if (context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity)
			{
				...
				{
					int cycle = ((OptionSetValue)targetEntity["dnlb_cycle"]).Value; //OptionSetValue: In Dynamics CRM, fields that represent options (such as dropdown lists) are often stored as OptionSetValue objects.
					switch (cycle)
					{
